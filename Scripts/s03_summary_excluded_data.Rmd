...
# Write to file
# Tab 1: summary
fileName <- paste0("omittedConcDataSummary_", delivery_date, ".csv")
write.csv(summaryExclConc,
            file = file.path(directories[["res_eda_dir"]], fileName),
            row.names = F)
...
fileName <- paste0("omittedDataListing_", delivery_date, ".csv")
